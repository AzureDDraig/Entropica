...
public class ModItems {
    ...
    // --- Block Items (The Modern Approach) ---
    ...
    // Added the Catalyst Receptacle Item
    ...
    // Your Custom Orbis Cell Item (Already modernized!)
