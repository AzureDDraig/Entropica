...
public class MateriaPlumeBlockEntity extends BlockEntity {
    private BlockPos masterPos = null;

    public MateriaPlumeBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MATERIA_PLUME_BE.get(), pos, state);
    }
    ...
    public int extractMateriaFumusFromAttachedCore(EssenceType type, int amount) {
        EntropicCoreBlockEntity master = getMaster();
        return master != null ? master.extractMateriaFumus(type, amount) : 0;
    }
}