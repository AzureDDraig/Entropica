...
import ddraig.net.entropica.block.entity.ThecaCellBlockEntity;
...
public class ThecaCellBlock extends Block implements EntityBlock {

    public ThecaCellBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new ThecaCellBlockEntity(pos, state);
    }
