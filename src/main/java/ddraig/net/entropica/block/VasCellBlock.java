...
import ddraig.net.entropica.block.entity.VasCellBlockEntity;
...
public class VasCellBlock extends Block implements EntityBlock {

    public VasCellBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new VasCellBlockEntity(pos, state);
    }
    ...
    public BlockState playerWillDestroy(Level level, BlockPos pos, BlockState state, Player player) {
        if (!level.isClientSide() && !player.isCreative()) {
            if (level.getBlockEntity(pos) instanceof VasCellBlockEntity cellBlockEntity) {
                ...
                tag.putInt("StoredMateria8", cellBlockEntity.getMateria());
