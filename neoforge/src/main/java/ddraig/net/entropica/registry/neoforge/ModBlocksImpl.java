...
public class ModBlocksImpl {
    public static RegistrySupplier<Block> registerDilutedEssenceBlock() {
        return ModBlocks.BLOCKS.register("diluted_essence_fluid_block",
                name -> new DilutedEssenceFluidBlock(ModFluidsNeoForge.getSource(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).setId(ResourceKey.create(Registries.BLOCK, name)).noLootTable().liquid()));
    }
}
