...
public class BlightFungalShelfCapBlock extends AbstractFungalShelfBlock {
    public static final MapCodec<BlightFungalShelfCapBlock> CODEC = simpleCodec(BlightFungalShelfCapBlock::new);

    public BlightFungalShelfCapBlock(Properties properties) {
        super(properties);
    }

    @Override
    protected MapCodec<BlightFungalShelfCapBlock> codec() {
        return CODEC;
    }
