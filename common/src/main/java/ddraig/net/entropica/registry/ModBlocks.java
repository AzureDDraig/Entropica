...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> POTTED_AURA_DRIFT_SEDGE = BLOCKS.register("potted_aura_drift_sedge", name -> new FlowerPotBlock(ModBlocks.AURA_DRIFT_SEDGE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_SPECTRAL_LANTERN_FLOWER = BLOCKS.register("potted_spectral_lantern_flower", name -> new FlowerPotBlock(ModBlocks.SPECTRAL_LANTERN_FLOWER.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_CINDER_SPORE_MUSHROOM = BLOCKS.register("potted_cinder_spore_mushroom", name -> new FlowerPotBlock(ModBlocks.CINDER_SPORE_MUSHROOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_NECROTIC_ROSE_OF_JERICHO = BLOCKS.register("potted_necrotic_rose_of_jericho", name -> new FlowerPotBlock(ModBlocks.NECROTIC_ROSE_OF_JERICHO.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_VOID_STALKER_ORCHID = BLOCKS.register("potted_void_stalker_orchid", name -> new FlowerPotBlock(ModBlocks.VOID_STALKER_ORCHID.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_STARDUST_ALOE = BLOCKS.register("potted_stardust_aloe", name -> new FlowerPotBlock(ModBlocks.STARDUST_ALOE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_BLOOD_ROOT_SUCCULENT = BLOCKS.register("potted_blood_root_succulent", name -> new FlowerPotBlock(ModBlocks.BLOOD_ROOT_SUCCULENT.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_AEGIS_SPIRE_ORCHID = BLOCKS.register("potted_aegis_spire_orchid", name -> new FlowerPotBlock(ModBlocks.AEGIS_SPIRE_ORCHID.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_SPORE_BURST_PUFFBALL = BLOCKS.register("potted_spore_burst_puffball", name -> new FlowerPotBlock(ModBlocks.SPORE_BURST_PUFFBALL.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_VITAE_ORCHID = BLOCKS.register("potted_vitae_orchid", name -> new FlowerPotBlock(ModBlocks.VITAE_ORCHID.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_SANGUINE_LILY = BLOCKS.register("potted_sanguine_lily", name -> new FlowerPotBlock(ModBlocks.SANGUINE_LILY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_ABYSSAL_WEEPROOT = BLOCKS.register("potted_abyssal_weeproot", name -> new FlowerPotBlock(ModBlocks.ABYSSAL_WEEPROOT.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_FULGURITE_SWAMP_BLOOM = BLOCKS.register("potted_fulgurite_swamp_bloom", name -> new FlowerPotBlock(ModBlocks.FULGURITE_SWAMP_BLOOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_CRYO_STATIC_SHRUB = BLOCKS.register("potted_cryo_static_shrub", name -> new FlowerPotBlock(ModBlocks.CRYO_STATIC_SHRUB.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_VITREOUS_CACTUS = BLOCKS.register("potted_vitreous_cactus", name -> new FlowerPotBlock(ModBlocks.VITREOUS_CACTUS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_SOOT_SHROUD_FUNGI = BLOCKS.register("potted_soot_shroud_fungi", name -> new FlowerPotBlock(ModBlocks.SOOT_SHROUD_FUNGI.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_STATIC_SPEAR_GRASS = BLOCKS.register("potted_static_spear_grass", name -> new FlowerPotBlock(ModBlocks.STATIC_SPEAR_GRASS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_AMBER_NECTAR_BLOSSOM = BLOCKS.register("potted_amber_nectar_blossom", name -> new FlowerPotBlock(ModBlocks.AMBER_NECTAR_BLOSSOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
    public static final RegistrySupplier<Block> POTTED_RIMEBLOOM = BLOCKS.register("potted_rimebloom", name -> new FlowerPotBlock(ModBlocks.RIMEBLOOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_POPPY)));
