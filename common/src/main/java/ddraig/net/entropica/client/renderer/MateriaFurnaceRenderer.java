...
public class MateriaFurnaceRenderer implements BlockEntityRenderer<MateriaFurnaceBlockEntity, MateriaFurnaceRenderer.FurnaceRenderState> {

    // Using the default white texture so we can freely color the bars
    private static final ResourceLocation WHITE_TEXTURE = ResourceLocation.withDefaultNamespace("textures/misc/white.png");

    public MateriaFurnaceRenderer(BlockEntityRendererProvider.Context context) {
    }
    ...
    @Override
    public void extractRenderState(MateriaFurnaceBlockEntity blockEntity, FurnaceRenderState renderState, float partialTick, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
        ...
        // UPDATED: Now uses MATERIA_FURNACE_MAX_ESSENCE from the config
