...
/**
 * Geometric shape handler for complete 360-degree spherical bubble forcefields (Spherical Bubble).
 */
public class SphericalBubbleShapeHandler implements BarrierShapeHandler {

    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("entropica", "spherical_bubble");
    ...
    public String getDisplayName() {
        return "Spherical Bubble";
    }

    @Override
    public String getDescription() {
        return "Complete 360-degree spherical forcefield barrier";
    }
    ...
    public BarrierRaycastHit intersect(
        ...
        return BarrierGeometry.intersectSphere(center, radius, rayStart, rayEnd, entityRadius);
    }
